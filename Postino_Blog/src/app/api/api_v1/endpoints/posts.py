...
def read_posts(
        ...
        show_archived: bool = Query(True, description="Whether to include archived posts"),
        show_inactive: bool = Query(True, description="Whether to include inactive posts"),
